...
type IconName = 'settings' | 'micOff' | 'connection' | 'micOn' | 'error' | 'brain' | 'trash' | 'plus' | 'close' | 'loader' | 'pause' | 'play' | 'chat' | 'history' | 'chevronLeft' | 'chevronRight' | 'dashboard' | 'shield' | 'sun' | 'moon' | 'sparkles' | 'check';
